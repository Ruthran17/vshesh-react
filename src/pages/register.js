    ...
    return(
      <div>
        ...
        { this.state.isVisible && <div>
          <img src={require("../images/20170520_115450.jpg").default} className="ship-img"/>
        </div> }
        ...
        <div className="bottom-space icon-align">
          ...
          { this.state.showPassword ? 
            ...
            :
            <img src={require("../images/close-eye.png").default} className="icon"
